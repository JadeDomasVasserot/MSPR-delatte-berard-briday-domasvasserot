...
class _PlanteScreen extends State<PlanteScreen> {
  ...
  void _submitForm() async {
    if (_formKey.currentState?.validate() ?? false) {
      try {
        Personne gardien = await getUserStatic(widget.id); // Mettre id Session
        StatutPlante statut = await getStatutPlante(2);
        GardePlante gardePlante = await getGardePlante(widget.id);
        GardePlante gardePlante2 = await addGardienGardePlante(
            gardePlante.id,
            gardePlante.plante,
            gardePlante.dateDebut,
            gardePlante.dateFin,
            statut,
            gardien);
      } catch (e) {
                                      ...
                                      child: Row(
                                        children: [
                                          ...
                                          Container(
                                              child: Text(
                                                  utf8.decode(
                                                      '${gardePlante.plante.bibliothequePlante.typePlante.nom}'
                                                          .codeUnits),
                                                  textAlign: TextAlign.left,
                                                  style: const TextStyle(
                                                    fontStyle: FontStyle.normal,
                                      ...
                                      child: Row(
                                        children: [
                                          ...
                                          Container(
                                              child: Text(
                                                  utf8.decode(
                                                      '${gardePlante.plante.proprietaire.nom} ${gardePlante.plante.proprietaire.prenom}'
                                                          .codeUnits),
                                                  textAlign: TextAlign.left,
                                                  style: const TextStyle(
                                                    fontStyle: FontStyle.normal,
                                          ...
                                          child: Wrap(children: [
                                            Container(
                                                ...
                                                child: OutlinedButton(
                                                  onPressed: () {
                                                    context.go(
                                                        "/profile/${gardePlante.plante.proprietaire.id}");
                                                  },
                                            ...
                                            FutureBuilder<Personne>(
                                                future: getUser(), // ID session
                                                builder: (BuildContext context,
                                                    AsyncSnapshot<Personne>
                                                        snapshot) {
                                                  if (snapshot.hasData) {
                                                    ...
                                                    return Container(
                                                        ...
                                                        child: personne.role
                                                            ...
                                                            ? OutlinedButton(
                                                                onPressed: () {
                                                                  context.go(
                                                                      "/create/commentaire/${gardePlante.id}");
                                                                },
                                                                style: ElevatedButton.styleFrom(
                                                                    shape: RoundedRectangleBorder(
                                                                        borderRadius:
