          ...
          if (snapshot.hasData) {
            ...
            return Scaffold(
                appBar: AppBar(
                    ...
                    title: Text(
                        utf8.decode(
                            '${plante.bibliothequePlante.nom}'.codeUnits),
                          ...
                          child: Column(
                              ...
                              children: <Widget>[
                                ...
                                FutureBuilder<List<GardePlante>>(
                                    ...
                                    builder: (BuildContext context,
                                        AsyncSnapshot<List<GardePlante>>
                                            snapshot) {
                                      if (snapshot.hasData) {
                                        List<GardePlante> gardePlantes =
                                            snapshot.data!;
                                        return Column(children: [
                                          for (GardePlante gardePlante
                                              in gardePlantes) // Garde
                                                          ...
                                                          gardePlante.gardien !=
                                                              ...
                                                              Row(
                                                                  children: [
                                                                    ...
                                                                    Container(
                                                                        child: Text(
                                                                            utf8.decode('${gardePlante.gardien?.nom}'
                                                                                .codeUnits),
                                                                            textAlign:
                                                                                TextAlign.left,
                                                                            style: const TextStyle(
                                                                ...
                                                                ? Container(
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      onPressed:
                                                                          () {
                                                                        context.go(
                                                                            "/profile/${gardePlante.gardien?.id}");
                                                                      },
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      onPressed: () => showDialog<
                                                                          ...
                                                                          context:
                                                                              context,
                                                                          builder: (BuildContext context) =>
                                                                              AlertDialog(title: const Text('Supprimer'), content: const Text('Voulez vous supprimer cette garde ? '), actions: <Widget>[
                                                                                TextButton(
                                                                                  onPressed: () {
