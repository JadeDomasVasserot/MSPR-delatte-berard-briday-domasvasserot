...
Future<List<PhotoPlante>> getAllPhotoPlanteOfPlante(int planteId) async {
  ...
  final response = await http.get(
      Uri.parse(
          'https://arosaje-back.jadedomasvasserot.com/photo-plante/all/idPlante/$planteId'),
      headers: {
        'accept': '*/*',
...
Future<PhotoPlante> getUrlOfPhotoPlante(int planteId) async {
  ...
  final response = await http.get(
      Uri.parse(
          'https://arosaje-back.jadedomasvasserot.com/photo-plante/one/idPlante/$planteId'),
      headers: {
        'accept': '*/*',
        'Content-Type': 'application/json; charset=UTF-8',
        'Authorization': 'Bearer $jwt',
...
Future<PhotoPlante> getLastPhotoPlante(int idPlante) async {
  ...
  final response = await http.get(
      Uri.parse(
          "https://arosaje-back.jadedomasvasserot.com/photo-plante/one/idPlante/$idPlante"),
      headers: {
        'accept': '*/*',
        'Content-Type': 'application/json; charset=UTF-8',
        'Authorization': 'Bearer $jwt',
