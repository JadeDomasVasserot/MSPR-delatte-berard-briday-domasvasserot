...
Future<VisitePlante> addVisite(Personne gardien, DateTime dateVisite,
  ...
  try {
    ...
    final response = await http.post(
      Uri.parse("https://arosaje-back.jadedomasvasserot.com/visite-plante/add"),
      headers: {
        'accept': '*/*',
...
Future<VisitePlante> updateVisite(
  ...
  try {
    ...
    final response = await http.put(
      Uri.parse(
          "https://arosaje-back.jadedomasvasserot.com/visite-plante/update"),
      headers: {
        'accept': '*/*',
        'Content-Type': 'application/json; charset=UTF-8',
        'Authorization': 'Bearer $jwt',
...
Future<List<VisitePlante>> getVisiteByGarde(int idGarde) async {
  ...
  final response = await http.get(
      Uri.parse(
          "https://arosaje-back.jadedomasvasserot.com/visite-plante/all/byGarde/$idGarde"),
      headers: {
        'accept': '*/*',
        'Content-Type': 'application/json; charset=UTF-8',
        'Authorization': 'Bearer $jwt',
...
Future<VisitePlante> getVisite(int idVisite) async {
  ...
  final response = await http.get(
      Uri.parse(
          "https://arosaje-back.jadedomasvasserot.com/visite-plante/id/$idVisite"),
      headers: {
        'accept': '*/*',
        'Content-Type': 'application/json; charset=UTF-8',
        'Authorization': 'Bearer $jwt',
