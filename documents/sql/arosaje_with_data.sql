...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : jeu. 02 mars 2023 à 21:56
...
(1, 'J\'ai cassé le pot de fleur', 'soir 11/02', 6, 6),
...
(6, 'Plante ok', 'Visite matin 14/12', 3, 15),
(7, 'arrosage + taillage', 'soir 20/02', 6, 3),
(8, 'Plante ok', 'midi 06/02', 6, 1);
...
(3, '2023-02-19', '2023-02-21', 6, 3, 3),
(4, '2023-02-08', '2023-02-22', NULL, 4, 2),
(5, '2023-02-20', '2023-02-28', 3, 5, 3),
...
(13, '2023-01-01', '2023-01-08', 6, 2, 1),
(14, '2023-01-02', '2023-01-03', NULL, 7, 2),
(15, '2022-12-14', '2022-12-20', 3, 5, 3);
...
CREATE TABLE IF NOT EXISTS `guide_plante` (
  ...
  `description` varchar(255) NOT NULL,
  `titre` varchar(255) NOT NULL,
  `bibliotheque_plante` int DEFAULT NULL,
  `type_guide` int NOT NULL,
  PRIMARY KEY (`id`),
...
(5, '30cl par jour pas plus', '2 fois par jours', 2, 2),
(6, 'avril et juin', 'Printemps', 17, 10),
(7, 'Arroser uniquement si pas de pluie', 'Tout les deux jours', 7, 2),
(8, 'Au soleil le matin, a l\'ombre l\'après-midi', 'Quel exposition pour mes iris', 3, 1),
(9, 'Souvent un manque d\'eau ou de nutriments', 'Feuille jaune', 12, 13),
(10, 'Endroit chaud assez isolé d\'autres plantes si possible', 'Ou planter mes dauphinelles', 16, 11);
...
(5, 'Route de l\'écluse Brotteau', 73310, 'duncan.delatte@epsi.fr', '$2y$10$CnFp56JiHCKbFGnLrGCuaONrv.itCx4exZZ6xTJcenUcA7M5Iij4O', 'DELATTE', 'Duncan', 'Vions', 5),
...
CREATE TABLE IF NOT EXISTS `photo_bibliotheque_plante` (
  `id` int NOT NULL AUTO_INCREMENT,
  `photo` varchar(255) DEFAULT NULL,
  `bibliotheque_plante` int NOT NULL,
  PRIMARY KEY (`id`),
...
(1, '2023-03-01', 'tulipe.jpg', 1, 6, 1, 2),
(2, '2023-03-01', NULL, 2, 6, 2, 3),
(3, '2023-03-01', NULL, 2, 6, 2, 4),
(4, '2023-02-15', NULL, 2, 6, 2, 5),
(5, '2023-02-11', NULL, 1, 6, 1, NULL),
(6, '2023-03-01', NULL, 3, 6, 3, NULL),
(7, '2023-02-23', NULL, 5, 6, 5, NULL),
(8, '2023-02-20', NULL, 3, 6, 2, 7);
