...
export default {
  ...
  methods: {
    getPlanteUserGarde() {
      axios.get("https://arosaje-back.jadedomasvasserot.com/garde-plante/all/byUser/" + this.$store.state.user + "/byStatus/" + 1,
        {
    ...
    getPlanteUserAGarde() {
      axios.get("https://arosaje-back.jadedomasvasserot.com/garde-plante/all/byUser/" + this.$store.state.user + "/byStatus/" + 2,
        {
          withCredentials: false,
          headers: {
            'Authorization': 'Bearer ' + this.$store.state.token,
    ...
    getGardeByUser() {
      axios.get("https://arosaje-back.jadedomasvasserot.com/garde-plante/all/byGardien/" + this.$store.state.user,
        {
          withCredentials: false,
          headers: {
            'Authorization': 'Bearer ' + this.$store.state.token,
